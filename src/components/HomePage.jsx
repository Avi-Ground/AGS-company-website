  ...
  return (
    <div className="hp-page">
      ...
      <section className="hp-about">
        <h2 className="hp-about-title">We are Aviation Ground Services</h2>
        ...
        <div className="hp-services-grid">
          <div className="hp-service-card">
            <div className="hp-service-img-wrap">
              <img src={cargoImg} alt="Cargo Services" className="hp-service-img" />
            </div>
            <div className="hp-service-info">
              <div className="hp-service-label">
                ...
                <span className="hp-service-name">Cargo Services</span>
              </div>
          ...
          <div className="hp-service-card">
            <div className="hp-service-img-wrap">
              <img src={passengerImg} alt="Passenger Handling" className="hp-service-img" />
            </div>
            <div className="hp-service-info">
              <div className="hp-service-label">
                <svg className="hp-service-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span className="hp-service-name">Passenger Handling</span>
              </div>
              <Link to="/our-services" className="hp-find-out-more">Find out more &rsaquo;</Link>
            </div>
          </div>
          ...
          <div className="hp-service-card">
            <div className="hp-service-img-wrap">
              <img src={rampImg} alt="Ramp Handling" className="hp-service-img" />
            </div>
            <div className="hp-service-info">
              <div className="hp-service-label">
                <svg className="hp-service-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span className="hp-service-name">Ramp Handling</span>
              </div>
              <Link to="/our-services" className="hp-find-out-more">Find out more &rsaquo;</Link>
            </div>
          </div>
        ...
        <div className="hp-stats-grid">
          <div className="hp-stat-card">
            <svg className="hp-stat-icon" viewBox="0 0 64 64" fill="none" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <circle cx="32" cy="20" r="8"/><circle cx="14" cy="24" r="6"/><circle cx="50" cy="24" r="6"/>
              <path d="M2 52c0-8 5-14 12-14h4M62 52c0-8-5-14-12-14h-4M20 52c0-10 5-16 12-16s12 6 12 16"/>
            </svg>
            <div className="hp-stat-number">250+</div>
            <div className="hp-stat-label">Employees nationwide</div>
          </div>
          <div className="hp-stat-card">
            <svg className="hp-stat-icon" viewBox="0 0 64 64" fill="none" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M8 40 L28 24 L38 32 L56 16"/>
              <circle cx="18" cy="48" r="4"/><circle cx="38" cy="48" r="4"/>
              <line x1="22" y1="48" x2="34" y2="48"/><line x1="8" y1="56" x2="56" y2="56"/>
            </svg>
            <div className="hp-stat-number">12</div>
            <div className="hp-stat-label">Airlines partnerships</div>
          </div>
          <div className="hp-stat-card">
            <svg className="hp-stat-icon" viewBox="0 0 64 64" fill="none" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="hp-stat-label">All airports nationwide</div>
          </div>
        </div>
      </section>
      ...
      <section className="hp-edge">
        <h2 className="hp-edge-title">The AGS EDGE</h2>
        <div className="hp-edge-photos">
          <div className="hp-edge-photo-wrap"><img src={edge1} alt="AGS operations" className="hp-edge-photo" /></div>
          <div className="hp-edge-photo-wrap"><img src={edge2} alt="AGS team" className="hp-edge-photo" /></div>
          <div className="hp-edge-photo-wrap"><img src={edge3} alt="AGS ground crew" className="hp-edge-photo" /></div>
          <div className="hp-edge-photo-wrap"><img src={edge4} alt="AGS staff" className="hp-edge-photo" /></div>
        </div>
        <p className="hp-edge-body">
        ...
        <h2 className="hp-why-title">Why choose AGS</h2>
        <div className="hp-why-grid">
          {[
            { label: 'Professionalism', path: 'M24 14h8M24 19h8M24 24h5', extra: <><rect x="18" y="8" width="20" height="26" rx="2"/><path d="M14 38h12l4 6 4-6h16v14H14z"/><path d="M28 44h8"/></> },
            { label: 'Accountability and Ownership', path: 'M24 28l6 6 10-12', extra: <><circle cx="32" cy="28" r="14"/><path d="M16 50c0-6 7-10 16-10s16 4 16 10"/><path d="M32 42v8"/></> },
            { label: 'Service Excellence', path: '', extra: <><circle cx="32" cy="32" r="12"/><path d="M32 20V12M32 52v-8M20 32h-8M52 32h-8"/><path d="M23.5 23.5l-5.7-5.7M46.2 46.2l-5.7-5.7M40.5 23.5l5.7-5.7M17.8 46.2l5.7-5.7"/><circle cx="32" cy="32" r="4"/></> },
            { label: 'Sustainability', path: '', extra: <><path d="M32 10 C20 10 12 20 12 30 c0 14 20 24 20 24 s20-10 20-24 c0-10-8-20-20-20z"/><path d="M24 30 c0-4 4-8 8-8 s8 4 8 8"/><path d="M22 38 q10 8 20 0"/></> },
            { label: 'Teamwork', path: '', extra: <><circle cx="32" cy="18" r="6"/><circle cx="14" cy="22" r="5"/><circle cx="50" cy="22" r="5"/><path d="M20 42c0-7 5-12 12-12s12 5 12 12"/><path d="M6 46c0-6 4-10 8-10"/><path d="M58 46c0-6-4-10-8-10"/></> },
            { label: 'Transparency', path: '', extra: <><circle cx="32" cy="24" r="10"/><path d="M20 44c0-6 5-10 12-10s12 4 12 10"/><path d="M10 20l4 4-4 4M54 20l-4 4 4 4"/><path d="M14 24h6M44 24h6"/></> },
          ].map((item, i) => (
      ...
      <section className="hp-news">
        <h2 className="hp-news-title">Latest business news</h2>
        <div className="hp-news-grid">
          <div className="hp-news-card">
            <div className="hp-news-img-wrap"><img src={news1} alt="AGS Begins Handling Qatar Airways" className="hp-news-img" /></div>
            <p className="hp-news-card-title">AGS Begins Handling Qatar Airways</p>
            <p className="hp-news-card-sub">Safety, efficiency, and hospitality take off with new partnership.</p>
          </div>
          <div className="hp-news-card">
            <div className="hp-news-img-wrap"><img src={news2} alt="From Belly to Bulk" className="hp-news-img" /></div>
            <p className="hp-news-card-title">From Belly to Bulk:</p>
            <p className="hp-news-card-sub">AGS Delivers Reliable Cargo Handling for Qatar</p>
          </div>
          <div className="hp-news-card">
            <div className="hp-news-img-wrap"><img src={news3} alt="AGS Expands Network" className="hp-news-img" /></div>
            <p className="hp-news-card-title">AGS Expands Network,</p>
            <p className="hp-news-card-sub">Starts Passenger Handling for Kenya Airways</p>
          </div>
        </div>
      </section>
